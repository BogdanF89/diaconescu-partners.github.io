...
const EN_KEYWORDS = [
  ...
  'criminal law', 'criminal proceedings', 'criminal liability',
  'legislation', 'legislative', 'regulation', 'directive', 'law reform',
  'legislative update', 'regulatory update', 'new regulation',
  'court ruling', 'judgment', 'ruling', 'case law',
  'appeal in the interest of law', 'binding interpretation', 'binding ruling',
  'amendment', 'amendments', 'legal reform',
  'supreme court', 'constitutional court', 'high court of cassation',
  'cjeu', 'court of justice', 'european court',
  'preventive concordat', 'pre-insolvency', 'creditor agreement',
  'transaction', 'transactions', 'merger', 'acquisition',
  'liquidation', 'liquidator', 'winding up',
  'debt', 'debts', 'recovery', 'enforcement',
  'romania', 'romanian',
];
